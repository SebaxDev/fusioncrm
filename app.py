...
# Versión 3.0 - Diseño CRM profesional para Render
# --------------------------------------------------
...
from components.auth import has_permission, check_authentication, render_login, init_auth_session, render_user_info
from components.navigation import render_sidebar_navigation  # <- SOLO navegación
...
def init_google_sheets():
    ...
    def _connect():
        # Para Render: usar variable de entorno con las credenciales
...
# ✅ INICIALIZAR ESTADO DE AUTENTICACIÓN (AGREGAR ESTO)
init_auth_session()
    ...
    st.markdown(
        ...
        <div style="margin-top: 2rem; padding: 1rem; background: var(--bg-surface); border-radius: var(--radius-lg); border: 1px solid var(--border-color);">
            <div style="text-align: center; margin-bottom: 1rem;">
                ...
                <p style="margin:0; font-size: 0.9rem; color: var(--text-secondary);"><strong>Versión:</strong> 3.0.0</p>
                <p style="margin:0; font-size: 0.8rem; color: var(--text-muted);">Optimizado para Render</p>
...
# --------------------------
# INTERFAZ PRINCIPAL OPTIMIZADA - ESTILO CRM
# --------------------------

st.markdown("""
<div style="text-align: center; padding: 2.5rem 0; background: linear-gradient(135deg, var(--primary-color) 0%, var(--primary-dark) 100%); border-radius: var(--radius-xl); margin: 2rem 0; border: 1px solid var(--border-color); box-shadow: var(--shadow-lg);">
    <h1 style="margin: 0; color: white; font-size: 2.8rem;">
        Fusion Reclamos CRM
    </h1>
    <div style="margin-top: 1rem;">
        <span style="background: white; color: var(--primary-color); padding: 0.25rem 1rem; border-radius: var(--radius-md); font-size: 0.9rem; font-weight: 500;">
