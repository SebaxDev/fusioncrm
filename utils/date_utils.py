...
def parse_fecha(
    ...
    formatos = [
        ...
        '%Y%m%d',             # 20231225
        '%m/%d/%Y %H:%M:%S',  # 12/25/2023 14:30:45 (formato US)
...
# Nueva función para manejo de fechas en entornos cloud
def fecha_para_cloud(fecha):
    """
    Optimiza el formato de fecha para entornos cloud como Render
    Devuelve fecha en formato ISO para mejor compatibilidad
    """
    try:
